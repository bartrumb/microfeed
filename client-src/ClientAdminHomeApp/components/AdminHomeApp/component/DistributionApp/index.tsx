...
import {
  DistributionBundle,
  DistributionAppProps,
  DistributionAppState
} from './types';

const DISTRIBUTION_BUNDLE: DistributionBundle[] = [
  {
    label: 'rss',
...
export default class DistributionApp extends React.Component<DistributionAppProps, DistributionAppState> {
  constructor(props: DistributionAppProps) {
    super(props);
    this.state = {};
  }
    ...
    return (
      <div className="lh-page-card">
        ...
        <div className="grid grid-cols-1 gap-8 mt-8">
          {DISTRIBUTION_BUNDLE.map((bundle) => (
            <div
              key={`b-${bundle.label}`}

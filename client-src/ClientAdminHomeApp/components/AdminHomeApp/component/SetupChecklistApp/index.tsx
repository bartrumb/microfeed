...
interface SetupPublicBucketUrlProps {
  onboardState: OnboardState;
...
interface SetupChecklistAppProps {
  feed?: Feed;
...
function CheckListItem({title, onboardState, children}: CheckListItemProps) {
  return (
    <div className="flex">
      <div className="mr-4">
...
function SetupPublicBucketUrl({onboardState, webGlobalSettings, cloudflareUrls}: SetupPublicBucketUrlProps) {
  ...
  return (
    <CheckListItem onboardState={onboardState} title="Setup R2 public bucket url">
      <div className="flex">
      ...
      <div className="mt-4 rounded bg-gray-100 p-2 text-sm grid grid-cols-1 gap-2">
        <details>
          ...
          <div className="my-8 text-helper-color">
            ...
            <div className="mt-4">
              ...
              <div className="mt-2">
                <img src="/assets/howto/get-r2-public-bucket-url-howto2.png" className="w-full" alt="R2 public bucket URL setup with custom domain" />
              </div>
            </div>
            <div className="mt-4">
              <div>
              ...
              <div className="mt-2">
                <img src="/assets/howto/get-r2-public-bucket-url-howto1.png" className="w-full" alt="R2 public bucket URL setup with r2.dev domain" />
              </div>
            </div>
          </div>
        </details>
        ...
        <details>
          ...
          <div className="my-8 text-helper-color">
            <div>
              When you open this R2 public bucket url, you will see a 404 page like this (e.g., <a href={OUR_BRAND.exampleCdnUrl} target="_blank" rel="noopener noreferrer">https://media-cdn.microfeed.org</a>):
            </div>
            <div className="mt-2">
              <img src="/assets/howto/get-r2-public-bucket-url-howto3.png" className="w-full" alt="404 page example for R2 public bucket URL" />
            </div>
          </div>
        </details>
      </div>
...
function ProtectedAdminDashboard({onboardState, cloudflareUrls}: ProtectedAdminDashboardProps) {
  return (
    <CheckListItem onboardState={onboardState} title="Add Login to Admin Dashboard">
      <div className="mt-4 rounded bg-gray-100 p-2 text-sm grid grid-cols-1 gap-2 text-helper-color">
        <div className="mb-2">
          You will use <a href="https://developers.cloudflare.com/cloudflare-one/applications/configure-apps/self-hosted-apps/" target="_blank" rel="noopener noreferrer">
        ...
        <details>
          ...
          <div className="mt-4">
            Go to <a href={cloudflareUrls.addAccessGroupUrl} target="_blank" rel="noopener noreferrer">Cloudflare Dashboard / Add an access group <span className="lh-icon-arrow-right"/></a>
          </div>
          <div className="my-4">
          ...
          <div className="mt-2">
            <img src="/assets/howto/add-access-group.png" className="w-full border" alt="Add access group setup" />
          </div>
        </details>
        <details>
          <summary className="cursor-pointer hover:opacity-50 text-black font-semibold">
          ...
          <div className="mt-4">
            Go to <a href={cloudflareUrls.addAppUrl} target="_blank" rel="noopener noreferrer">
          ...
          <div className="mt-2">
            <img src="/assets/howto/select-self-hosted-app.png" className="w-full border" alt="Select self-hosted app" />
          </div>
          <div className="mt-4">
          ...
          <div className="mt-2">
            <img src="/assets/howto/add-app1.png" className="w-full border" alt="Add app step 1" />
          </div>
          <div className="mt-4">
            Add policy name, then click "Next" all the way until you add the app:
          </div>
          <div className="my-4">
            <img src="/assets/howto/add-app2.png" className="w-full border" alt="Add app step 2" />
          </div>
        </details>
        <details>
          <summary className="cursor-pointer hover:opacity-50 text-black font-semibold">
          ...
          <div className="my-4">
            <img src="/assets/howto/app-access-login.png" className="w-full border" alt="App access login screen" />
          </div>
        </details>
        <details>
          <summary className="cursor-pointer hover:opacity-50 text-black font-semibold">
          ...
          protect all <a href="https://developers.cloudflare.com/pages/platform/preview-deployments/" target="_blank" rel="noopener noreferrer">preview
          deployments</a>.
          </div>
          <div className="mt-4">
            Go to <a href={cloudflareUrls.addAppUrl} target="_blank" rel="noopener noreferrer">
          ...
          <div className="my-4">
            <img src="/assets/howto/protect-preview.png" className="w-full border" alt="Protect preview deployments setup" />
          </div>
        </details>
      </div>
    </CheckListItem>
...
function CustomDomain({onboardState, cloudflareUrls}: CustomDomainProps) {
  return (
    <CheckListItem onboardState={onboardState} title="Use Custom Domain">
      <div className="mt-4 rounded bg-gray-100 p-2 text-sm grid grid-cols-1 gap-2 text-helper-color">
        <div className="mb-2">
        ...
        <details>
          ...
          <div className="mt-4">
            Go to <a href={cloudflareUrls.pagesCustomDomainUrl} target="_blank" rel="noopener noreferrer">Cloudflare Dashboard / Pages Settings<span
            className="lh-icon-arrow-right"/></a>
          </div>
          <div className="my-4">
            <img src="/assets/howto/pages-custom-domain.png" className="w-full border" alt="Pages custom domain setup" />
          </div>
        </details>
        <details>
          <summary className="cursor-pointer hover:opacity-50 text-black font-semibold">
          ...
          <div className="my-4">
            <img src="/assets/howto/add-app3.png" className="w-full border" alt="Add app for custom domain" />
          </div>
        </details>
      </div>
    </CheckListItem>
...
export default class SetupChecklistApp extends React.Component<SetupChecklistAppProps> {
  render() {
    const {feed = {}, onboardingResult = {}} = this.props;
    const {settings = {}} = feed;
    const webGlobalSettings = settings[SETTINGS_CATEGORIES.WEB_GLOBAL_SETTINGS] || {};

    // Get onboard states with default values
    const publicBucketUrlState = {
      ...defaultOnboardState,
      ...(onboardingResult.result?.[ONBOARDING_TYPES.VALID_PUBLIC_BUCKET_URL] || {})
    };

    const protectedAdminState = {
      ...defaultOnboardState,
      ...(onboardingResult.result?.[ONBOARDING_TYPES.PROTECTED_ADMIN_DASHBOARD] || {})
    };

    const customDomainState = {
      ...defaultOnboardState,
      ...(onboardingResult.result?.[ONBOARDING_TYPES.CUSTOM_DOMAIN] || {})
    };
    ...
    return (
      <div className="lh-page-card">
        ...
        {onboardingResult.allOk && (
          <div className="text-helper-color border border-green-700 bg-green-100 text-green-700 rounded p-2">
            <i>You are all set!</i>
            <div className="mt-2">
        ...
        <div className="mt-8">
          <SetupPublicBucketUrl
            onboardState={publicBucketUrlState}
            webGlobalSettings={webGlobalSettings}
            cloudflareUrls={onboardingResult.cloudflareUrls || {}}
          />
          <ProtectedAdminDashboard
            onboardState={protectedAdminState}
            cloudflareUrls={onboardingResult.cloudflareUrls || {}}
          />
          <CustomDomain
            onboardState={customDomainState}
            cloudflareUrls={onboardingResult.cloudflareUrls || {}}
          />
        </div>
